...
user_records=JSON.parse(localStorage.getItem("users"))?JSON.parse(localStorage.getItem("users")):[]
  ...
  // addDiv.innerHTML='  <div class="col-sm-4" style="padding: 10px;">'+user_records[i].firstName+'</div><div class="col-sm-4" style="padding: 10px;">'+user_records[i].email+'</div><div class="col-sm-4" style="padding: 10px;">'+user_records[i].psw+'</div>';
  // document.getElementById("employeeList").appendChild(addDiv);
